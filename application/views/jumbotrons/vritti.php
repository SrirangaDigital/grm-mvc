    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h4>श्रीमन्नागोजीभट्टकृतः</h4>
                <h1>वृत्तिः</h1>
                <ul class="list-inline auxiliary-links">
                    <li class="list-inline-item"><a href="#VRT_C01">समाधिपादः</a></li>
                    <li class="list-inline-item"><a href="#VRT_C02">साधनपादः</a></li>
                    <li class="list-inline-item"><a href="#VRT_C03">विभूतिपादः</a></li>
                    <li class="list-inline-item"><a href="#VRT_C04">कैवल्यपादः</a></li>
                </ul>
