    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h4>श्री-वाचस्पति-मिश्र-प्रणीता</h4>
                <h1>तत्त्व-वैशारदी-टीका</h1>

                <h5>व्यासविरचितम्</h5>
                <h2>पातञ्जल-योगसूत्र-भाष्य-सहितम्</h2>

                <ul class="list-inline auxiliary-links">
                    <li class="list-inline-item"><a href="#VYB_C01">समाधिपादः</a></li>
                    <li class="list-inline-item"><a href="#VYB_C02">साधनपादः</a></li>
                    <li class="list-inline-item"><a href="#VYB_C03">विभूतिपादः</a></li>
                    <li class="list-inline-item"><a href="#VYB_C04">कैवल्यपादः</a></li>
                </ul>
