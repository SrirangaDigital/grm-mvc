    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h4>श्रीमत्सदाशिवेन्द्रसरस्वतीकृतः</h4>
                <h1>योगसुधाकरः</h1>
                <ul class="list-inline auxiliary-links">
                    <li class="list-inline-item"><a href="#YOS_C01">समाधिपादः</a></li>
                    <li class="list-inline-item"><a href="#YOS_C02">साधनपादः</a></li>
                    <li class="list-inline-item"><a href="#YOS_C03">विभूतिपादः</a></li>
                    <li class="list-inline-item"><a href="#YOS_C04">कैवल्यपादः</a></li>
                </ul>
