...
<h2 class="purana-title">ಹುಡುಕಿ</h2>
<div id="kbd">
			...
			<tr>
				...
				<td>
					<select name="collection" id="collection">
						...
						<option value="001">ಶ್ರೀ ಜಯಚಾಮರಾಜೇಂದ್ರ ಗ್ರಂಥರತ್ನಮಾಲಾ ಸಂಗ್ರಹ</option>
						<option value="002">The Collection of Hindu Law Texts</option>
						<option value="003">ವಾಣಿವಿಲಾಸ್ ಸಂಗ್ರಹ</option>
						<option value="004">ಸಪ್ನಾ ಬುಕ್ ಹೌಸ್ ಸಂಗ್ರಹ</option>
					</select>
				</td>
			</tr>
			<tr class="gap-above-med">
				<td>ಪದಗಳನ್ನು ನಮೂದಿಸಿ</td>
				<td><input name="text" type="text" id="title" onfocus="SetId('title')"/></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td class="submit">
					<input name="button1" type="submit" id="button" value="ಹುಡುಕಿ"/>
					<input name="button2" type="reset" id="button2" value="ಅಳಿಸಿ"/>
				</td>
			</tr>
		</table>
	</form>
