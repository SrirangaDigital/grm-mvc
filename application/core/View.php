...
class View {
    ...
    public $bhashyaDef = array("VYB"=>"vyasa-bhashyam", "VYT"=>"vyasa-bhashyam-tamil", "HYP"=>"hathayoga-pradipika", "YOV"=>"yogavalli-bhashyam", "BHG"=>"bhagavadgita", "TVV"=>"tattvavaisharadi-vyakhya", "YVV"=>"yogavartikam-vyakhya", "VIV"=>"vivaranam-vyakhya", "REF"=>"reflections", "BAV"=>"bhasvati-vyakhya", "PRV"=>"patanjalarahasyam-vyakhya", "YOC"=>"yoga-chandrika", "YOM"=>"yoga-maniprabha", "YOS"=>"yoga-sudhakara", "PRA"=>"pradipika", "VRT"=>"vritti", "SUT"=>"sutrarthabodhini", "RAJ"=>"rajamartanda");
